...
import opportunities.preowned.FastestSellingInventory as FastestSellingInventory
...
def widgetHeading = findTestObject('Opportunities/Inventory/Fastest Selling Inventory/Pre-Owned - Fastest Selling Inventory - Heading')
...
WebUI.verifyEqual(widgetHeadingText, 'Fastest Selling Inventory', FailureHandling.CONTINUE_ON_FAILURE)

// Select colum
def selectionInfo = [('groupName') : null, ('column') : null]

def successfullyClickedColumnInWidget = CustomKeywords.'opportunities.preowned.Common.clickLinkInWidget'(Common.PreownedDashboardWidgets.FASTEST_SELLING_INVENTORY, selectionInfo)
