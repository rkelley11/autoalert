...
import opportunities.preowned.TopUsedCarSalesOpportunities as TopUsedCarSalesOpportunities
...
def widgetHeading = findTestObject('Opportunities/Inventory/Top Used Car Sales Opportunities/Pre-Owned - Top Used Car Sales Opportunities - Heading')
...
WebUI.verifyEqual(widgetHeadingText, 'Top Used Car Sales Opportunities', FailureHandling.CONTINUE_ON_FAILURE)

// Select colum
def selectionInfo = [('stockNumber') : null, ('column') : TopUsedCarSalesOpportunities.Columns.POTENTIAL_CUSTOMERS]

def successfullyClickedColumnInWidget = CustomKeywords.'opportunities.preowned.Common.clickLinkInWidget'(Common.PreownedDashboardWidgets.TOP_USED_CAR_SALES_OPPORTUNITIES, selectionInfo)
