...
// Verify tab
testObjectUnderTest = findTestObject('Opportunities/Admin/Settings/General/Dealership Settings General Tab')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'GENERAL', AfterFailure.CONTINUE)

CustomKeywords.'test.Assistant.verifiedClick'(testObjectUnderTest, AfterFailure.STOP)

// Verify tab header
testObjectUnderTest = findTestObject('Opportunities/Admin/Settings/General/Lease Mileage Defaults Header')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'Lease Mileage Defaults', AfterFailure.CONTINUE)