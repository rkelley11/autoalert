...
// Verify tab
testObjectUnderTest = findTestObject('Opportunities/Admin/Settings/CRM Leads Delivery/Dealership Settings CRM Leads Delivery Tab')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'CRM LEADS DELIVERY', AfterFailure.CONTINUE)

CustomKeywords.'test.Assistant.verifiedClick'(testObjectUnderTest, AfterFailure.STOP)

// Verify tab header
testObjectUnderTest = findTestObject('Opportunities/Admin/Settings/CRM Leads Delivery/CRM Leads Delivery Header')
