...
def dealerSelectSuccessful = CustomKeywords.'opportunities.DealerSelect.selectDealer'(dealer)

CustomKeywords.'test.Assistant.verifyTrue'(dealerSelectSuccessful, (dealer as String) + ' selected' , AfterFailure.STOP)
...
// Verify tab
testObjectUnderTest = findTestObject('Opportunities/Admin/Settings/Product/Admin - Settings - Product - Tab')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'PRODUCT', AfterFailure.CONTINUE)

CustomKeywords.'test.Assistant.verifiedClick'(testObjectUnderTest, AfterFailure.STOP)

// Verify tab header
testObjectUnderTest = findTestObject('Opportunities/Admin/Settings/Product/Admin - Settings - Product - Data View Settings - Header')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'Data View Settings', AfterFailure.CONTINUE)