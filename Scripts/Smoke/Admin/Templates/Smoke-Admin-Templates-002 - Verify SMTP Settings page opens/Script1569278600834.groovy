...
// Verify tab
testObjectUnderTest = findTestObject('Opportunities/Admin/Templates/SMTP Settings/SMTP Settings Tab')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'SMTP Settings', AfterFailure.CONTINUE)

CustomKeywords.'test.Assistant.verifiedClick'(testObjectUnderTest, AfterFailure.STOP)

// Verify header
testObjectUnderTest = findTestObject('Object Repository/Opportunities/Admin/Templates/SMTP Settings/Send E-mail Using Header')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'Send e-mail using:', AfterFailure.CONTINUE)
