...
// Verify tab
testObjectUnderTest = findTestObject('Opportunities/Admin/Templates/Upgrade Proposal/Upgrade Proposal Tab')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'Upgrade Proposal', AfterFailure.CONTINUE)

CustomKeywords.'test.Assistant.verifiedClick'(testObjectUnderTest, AfterFailure.STOP)

// Verify header
testObjectUnderTest = findTestObject('Opportunities/Admin/Templates/Upgrade Proposal/Upgrade Proposal - Marketing Message - Label')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'Marketing Message :', AfterFailure.CONTINUE)
