...
// Verify tab
testObjectUnderTest = findTestObject('Opportunities/Data Entry/Replacement Offers/Replacements Tab/Replacement Tab Header')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'REPLACEMENTS', 'tab', AfterFailure.CONTINUE)
...
testObjectUnderTest = findTestObject('Opportunities/Data Entry/Replacement Offers/Replacements Tab/Replacement Tab Container')
