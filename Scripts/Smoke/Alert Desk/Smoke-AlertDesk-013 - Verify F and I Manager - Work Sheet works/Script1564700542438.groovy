...
testObjectUnderTest = findTestObject('Opportunities/Alert Desk/F and I Manager/Work Sheet/F and I Manager - Work Sheet - Tab')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'Work Sheet', 'tab', AfterFailure.CONTINUE)
