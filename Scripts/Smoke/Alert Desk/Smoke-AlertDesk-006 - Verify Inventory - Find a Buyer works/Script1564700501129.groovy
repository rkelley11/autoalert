...
testObjectUnderTest = findTestObject('Opportunities/Alert Desk/Inventory/Find a Buyer/Inventory - Find a Buyer - Tab')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'Find a Buyer', 'tab', AfterFailure.CONTINUE)
...
// Click search
testObjectUnderTest = findTestObject('Opportunities/Alert Desk/Inventory/Find a Buyer/Inventory - Find a Buyer - Button - Search')
...
CustomKeywords.'test.Assistant.verifyNotEqual'(numberOfRowsShown, null, "Rows displayed on Find a Buyer tab", AfterFailure.STOP)