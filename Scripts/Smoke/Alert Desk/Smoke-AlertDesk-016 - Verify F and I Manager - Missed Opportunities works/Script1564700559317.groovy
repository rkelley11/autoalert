...
testObjectUnderTest = findTestObject('Opportunities/Alert Desk/F and I Manager/Missed Opportunities/F and I Manager - Missed Opportunities - Tab')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'Missed Opportunities', 'tab', AfterFailure.CONTINUE)
...
CustomKeywords.'test.Assistant.verifyNotEqual'(numberOfRowsShown, null, "Rows displayed on Missed Opportunities tab", AfterFailure.STOP)