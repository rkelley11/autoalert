...
testObjectUnderTest = findTestObject('Opportunities/Alert Desk/F and I Manager/Compare/F and I Manager - Compare - Tab')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'Compare', 'tab', AfterFailure.CONTINUE)
...
CustomKeywords.'test.Assistant.verifyNotEqual'(numberOfRowsShown, null, "Rows displayed on Compare tab", AfterFailure.STOP)