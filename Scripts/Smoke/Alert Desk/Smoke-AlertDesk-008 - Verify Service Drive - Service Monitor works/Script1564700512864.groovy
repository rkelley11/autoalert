...
testObjectUnderTest = findTestObject('Opportunities/Alert Desk/Service Drive/Service Monitor/Service Drive - Service Monitor - Tab')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'ServiceMonitor', 'tab', AfterFailure.CONTINUE)
...
CustomKeywords.'test.Assistant.verifyNotEqual'(numberOfRowsShown, null, "Rows displayed on ServiceMonitor tab", AfterFailure.STOP)