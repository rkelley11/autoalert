...
testObjectUnderTest = findTestObject('Opportunities/Alert Desk/Service Drive/Have Not Serviced/Service Drive - Have Not Serviced - Tab')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'Have Not Serviced', 'tab', AfterFailure.CONTINUE)
...
CustomKeywords.'test.Assistant.verifyNotEqual'(numberOfRowsShown, null, "Rows displayed on Have Not Serviced tab", AfterFailure.STOP)