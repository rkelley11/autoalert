...
testObjectUnderTest = findTestObject('Opportunities/Alert Desk/Service Drive/Service Appointments/Service Drive - Service Appointments - Tab')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'Service Appointments', 'tab', AfterFailure.CONTINUE)
...
CustomKeywords.'test.Assistant.verifyNotEqual'(numberOfRowsShown, null, "Rows displayed on Work Sheet tab", AfterFailure.STOP)