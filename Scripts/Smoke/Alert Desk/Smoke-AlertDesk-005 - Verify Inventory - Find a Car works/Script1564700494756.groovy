...
testObjectUnderTest = findTestObject('Opportunities/Alert Desk/Inventory/Find a Car/Inventory - Find a Car - Tab')

CustomKeywords.'test.Assistant.waitForElementVisible'(testObjectUnderTest, 10, AfterFailure.STOP)

CustomKeywords.'test.Assistant.verifyText'(testObjectUnderTest, 'Find a Car', 'tab', AfterFailure.CONTINUE)
...
// Click search
testObjectUnderTest = findTestObject('Opportunities/Alert Desk/Inventory/Find a Car/Inventory - Find a Car - Button - Search')
...
CustomKeywords.'test.Assistant.verifyNotEqual'(numberOfRowsShown, null, "Rows displayed on Find a Car tab", AfterFailure.STOP)