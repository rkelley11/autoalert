...
// Verify Quick Link
def quickLink = findTestObject('Opportunities/Alert Desk/Dashboard/Quick Links/Quick Links - Find a Buyer')
...
if(elementVisible){
	...
	WebUI.verifyEqual(elementText, 'Find a Buyer', FailureHandling.CONTINUE_ON_FAILURE)
...
// Verify Heading
def heading = findTestObject('Opportunities/Alert Desk/Inventory/Inventory Header')
...
if(elementVisible){
	...
	WebUI.verifyEqual(elementText, 'Inventory', FailureHandling.CONTINUE_ON_FAILURE)
}

// Verify tab
def tab = findTestObject('Opportunities/Alert Desk/Inventory/Find Pre-Owned Opportunities/Inventory - Find Inventory Opportunities - Tab')
...
if(elementVisible){
	...
	WebUI.verifyEqual(elementText, 'Find Pre-Owned Opportunities', FailureHandling.CONTINUE_ON_FAILURE)
...
def searchButton = findTestObject('Opportunities/Alert Desk/Inventory/Find Pre-Owned Opportunities/Inventory - Find Inventory Opportunities - Button - Search')
