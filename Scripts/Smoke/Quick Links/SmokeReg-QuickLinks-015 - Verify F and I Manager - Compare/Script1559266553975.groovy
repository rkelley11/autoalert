...
// Verify tab
def tab = findTestObject('Opportunities/Alert Desk/F and I Manager/Compare/F and I Manager - Compare - Tab')
...
if(elementVisible){
	...
	WebUI.verifyEqual(elementText, 'Compare', FailureHandling.CONTINUE_ON_FAILURE)
