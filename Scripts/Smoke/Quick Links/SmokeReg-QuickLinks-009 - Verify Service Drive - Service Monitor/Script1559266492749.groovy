...
// Verify tab
def tab = findTestObject('Opportunities/Alert Desk/Service Drive/Service Monitor/Service Drive - Service Monitor - Tab')
...
if(elementVisible){
	...
	WebUI.verifyEqual(elementText, 'ServiceMonitor', FailureHandling.CONTINUE_ON_FAILURE)
...
def searchButton = findTestObject('Opportunities/Alert Desk/Service Drive/Service Monitor/Service Drive - Service Monitor - Button - Search')
