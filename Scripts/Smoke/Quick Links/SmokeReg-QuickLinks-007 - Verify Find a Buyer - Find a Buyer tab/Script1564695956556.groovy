...
// Verify tab and is active
def tab = findTestObject('Opportunities/Alert Desk/Inventory/Find a Buyer/Inventory - Find a Buyer - Tab')
...
def searchButton = findTestObject('Opportunities/Alert Desk/Inventory/Find a Buyer/Inventory - Find a Buyer - Button - Search')
