...
// Verify Find a Car tab
def tab = findTestObject('Opportunities/Alert Desk/Inventory/Find a Car/Inventory - Find a Car - Tab')
...
if(elementVisible){
	...
	WebUI.verifyEqual(elementText, 'Find a Car', FailureHandling.CONTINUE_ON_FAILURE)
...
def searchButton = findTestObject('Opportunities/Alert Desk/Inventory/Find a Car/Inventory - Find a Car - Button - Search')
