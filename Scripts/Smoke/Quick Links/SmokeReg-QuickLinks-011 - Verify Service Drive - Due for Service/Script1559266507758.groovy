...
// Verify tab
def tab = findTestObject('Opportunities/Alert Desk/Service Drive/Due for Service/Service Drive - Due for Service - Tab')
...
if(elementVisible){
	...
	WebUI.verifyEqual(elementText, 'Due for Service', FailureHandling.CONTINUE_ON_FAILURE)
...
def searchButton = findTestObject('Opportunities/Alert Desk/Service Drive/Due for Service/Service Drive - Due for Service - Button - Search')
