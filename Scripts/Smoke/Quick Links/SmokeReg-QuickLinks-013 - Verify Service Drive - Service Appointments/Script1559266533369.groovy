...
// Verify tab
def tab = findTestObject('Opportunities/Alert Desk/Service Drive/Service Appointments/Service Drive - Service Appointments - Tab')
...
if(elementVisible){
	...
	WebUI.verifyEqual(elementText, 'Service Appointments', FailureHandling.CONTINUE_ON_FAILURE)
...
def searchButton = findTestObject('Opportunities/Alert Desk/Service Drive/Service Appointments/Service Drive - Service Appointments - Button - Search')
