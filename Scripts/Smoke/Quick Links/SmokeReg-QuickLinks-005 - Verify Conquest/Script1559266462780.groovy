...
// Verify Quick Link
def quickLink = findTestObject('Opportunities/Alert Desk/Dashboard/Quick Links/Quick Links - Service Conquests')
...
if(elementVisible){
	...
	WebUI.verifyEqual(elementText, 'Service Conquests', FailureHandling.CONTINUE_ON_FAILURE)
...
// Verify Heading
def heading = findTestObject('Opportunities/Alert Desk/Conquest/Conquest Header')
...
if(elementVisible){
	...
	WebUI.verifyEqual(elementText, 'Conquest', FailureHandling.CONTINUE_ON_FAILURE)
}

// Verify there are rows displaying on results
