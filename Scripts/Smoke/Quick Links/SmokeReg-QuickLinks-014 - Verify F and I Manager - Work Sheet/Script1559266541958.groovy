...
// Verify tab
def tab = findTestObject('Opportunities/Alert Desk/F and I Manager/Work Sheet/F and I Manager - Work Sheet - Tab')
...
if(elementVisible){
	...
	WebUI.verifyEqual(elementText, 'Work Sheet', FailureHandling.CONTINUE_ON_FAILURE)
	
	//def clicked = CustomKeywords.'general.WrappedSelenium.click'(tab) // It's supposed to default on this tab
