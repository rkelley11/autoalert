...
// Verify tab
def tab = findTestObject('Opportunities/Alert Desk/Service Drive/Have Not Serviced/Service Drive - Have Not Serviced - Tab')
...
if(elementVisible){
	...
	WebUI.verifyEqual(elementText, 'Have Not Serviced', FailureHandling.CONTINUE_ON_FAILURE)
...
def searchButton = findTestObject('Opportunities/Alert Desk/Service Drive/Have Not Serviced/Service Drive - Have Not Serviced - Button - Search')
