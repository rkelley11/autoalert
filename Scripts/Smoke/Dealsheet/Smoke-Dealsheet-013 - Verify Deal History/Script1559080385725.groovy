...
// Opening Tab
def tabOpened = CustomKeywords.'dealsheet.bottom.Common.openTab'(BottomSectionTabs2.DEAL_HISTORY)

WebUI.verifyEqual(tabOpened, true, FailureHandling.CONTINUE_ON_FAILURE)

// Verify Heading
def mainHeading = findTestObject('Dealsheet/Tabs/Deal History/Dealsheet - Tabs - Deal History - Heading')
...
if (elementVisible) {
    ...
    WebUI.verifyEqual(elementText, 'Deal History (Last 90 Days)', FailureHandling.CONTINUE_ON_FAILURE)
}