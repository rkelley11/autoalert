...
// Opening Tab
def tabOpened = CustomKeywords.'dealsheet.bottom.Common.openTab'(BottomSectionTabs2.OTHER_VEHICLES_OWNED)

WebUI.verifyEqual(tabOpened, true, FailureHandling.CONTINUE_ON_FAILURE)

// Verify Heading
def mainHeading = findTestObject('Dealsheet/Tabs/Other Vehicles Owned/Dealsheet - Tabs - Other Vehicles Owned - Heading')
...
if (elementVisible) {
    ...
    WebUI.verifyEqual(elementText, 'Other Vehicles Owned', FailureHandling.CONTINUE_ON_FAILURE)
}