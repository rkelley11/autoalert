...
elementVisible = WebUI.waitForElementVisible(findTestObject('Opportunities/Alert Desk/Sub Menu - Alert Desk'),
	30)
...
elementVisible = WebUI.waitForElementVisible(findTestObject('Opportunities/Alert Desk/Hover Over Dropdown List/Hover Over Dashboard Link'),
	10)
...
elementVisible = WebUI.waitForElementVisible(findTestObject('Dealsheet/Top Section/Reassign Client/Reassign Client'), 10)

assert elementVisible

elementClicked = CustomKeywords.'general.WrappedSelenium.click'(findTestObject('Dealsheet/Top Section/Reassign Client/Reassign Client'))

assert elementClicked

enteredDealerName = CustomKeywords.'dealsheet.Common.assignDealer'('')

elementVisible = WebUI.waitForElementVisible(findTestObject('Dealsheet/Top Section/Reassign Client/Reassign Client - Current Dealer'),
	10)

assert elementVisible

currentDealer = WebUI.getText(findTestObject('Dealsheet/Top Section/Reassign Client/Reassign Client - Current Dealer'))

assert currentDealer == enteredDealerName