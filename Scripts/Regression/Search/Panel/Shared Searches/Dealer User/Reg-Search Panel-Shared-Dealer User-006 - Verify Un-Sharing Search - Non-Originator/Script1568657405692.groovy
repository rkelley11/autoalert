...
def originator = 'automation4'

def nonOriginator = 'automation5'

// Login
new Initialize().readySetGo(originator)
...
new Initialize().readySetGo(nonOriginator)
...
expanded = !classes.contains('ng-hide')
...
// Verify search is NOT in My Search section
...
CustomKeywords.'test.Assistant.verifyFalse'(search['exists'], '\'' + searchName + '\' search was NOT found in ' + sectionHeader, AfterFailure.STOP)

// Verify search is NOT in Shared Search section
searchSection = ExpandableSearch.SHARED_SEARCHES
...
// Verify if search is in My Searches section
searchSection = ExpandableSearch.MY_SEARCHES
